...
func CheckOperations[S, I, O any](model Model[S, I, O], history []Operation) bool {
...
func CheckOperationsTimeout[S, I, O any](model Model[S, I, O], history []Operation, timeout time.Duration) CheckResult {
...
func CheckOperationsVerbose[S, I, O any](model Model[S, I, O], history []Operation, timeout time.Duration) (CheckResult, LinearizationInfo) {
	return checkOperations(model, history, true, timeout)
}

// CheckEvents checks whether a history is linearizable.
func CheckEvents[S, I, O any](model Model[S, I, O], history []Event) bool {
...
//
// A timeout of 0 is interpreted as an unlimited timeout.
func CheckEventsTimeout[S, I, O any](model Model[S, I, O], history []Event, timeout time.Duration) CheckResult {
...
//
// The returned LinearizationInfo can be used with [Visualize].
func CheckEventsVerbose[S, I, O any](model Model[S, I, O], history []Event, timeout time.Duration) (CheckResult, LinearizationInfo) {
